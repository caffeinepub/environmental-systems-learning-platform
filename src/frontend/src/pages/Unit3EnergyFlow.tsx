...
export default function Unit3EnergyFlow() {
  ...
  return (
    <UnitLayout unitNumber={3} unitTitle="Energy Flow in Environmental Systems">
      <ReadingContent subtopics={unitReadingContent.unit3} />
      ...
      <section className="my-12">
        <div className="p-6 rounded-2xl bg-gradient-to-br from-forestGreen/5 to-moss/10 border-2 border-forestGreen/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <button
              onClick={() => scrollToSection('energy-flow-activities')}
            ...
            >
              <h4 className="font-semibold text-forestGreen group-hover:underline">
                Energy Pyramid Builder
              </h4>
              <p className="text-sm text-muted-foreground mt-1">
                Build and analyze energy pyramids
              </p>
            </button>
            <button
              onClick={() => scrollToSection('energy-flow-activities')}
            ...
            >
              <h4 className="font-semibold text-forestGreen group-hover:underline">
                Trophic Level Simulator
              </h4>
              <p className="text-sm text-muted-foreground mt-1">
                Explore energy transfer between levels
              </p>
            </button>
          </div>
        </div>
      ...
      <section id="energy-flow-activities" className="my-12 scroll-mt-24">
        <h2 className="text-3xl font-display font-bold mb-6">Interactive Activities</h2>
        <div className="p-6 rounded-2xl bg-card border border-border">
          <p className="text-muted-foreground">
            Energy pyramid builder, heat transfer simulation, and Earth system interactions coming soon.
          </p>
        </div>
      </section>

      <VideoEmbed videos={unitVideos.unit3} />
      <WebQuest content={unitWebQuests.unit3} />
      <FunFacts facts={unitFunFacts.unit3} />
      <CareerExploration careers={unitCareers.unit3} />
      <STEMConnectionsSection />
      <SelfCheckingQuiz quiz={unitQuizzes.unit3} unitId="unit3" />
    </UnitLayout>
  );
}
