...
export default function Unit8EthicsEconomics() {
  ...
  return (
    <UnitLayout unitNumber={8} unitTitle="Ethics & Economic Priorities">
      <ReadingContent subtopics={unitReadingContent.unit8} />
      ...
      <section className="my-12">
        <div className="p-6 rounded-2xl bg-gradient-to-br from-forestGreen/5 to-moss/10 border-2 border-forestGreen/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <button
              onClick={() => scrollToSection('ethics-economics-activities')}
      ...
      <section id="ethics-economics-activities" className="my-12 scroll-mt-24">
        <h2 className="text-3xl font-display font-bold mb-6">Interactive Activities</h2>
        <div className="p-6 rounded-2xl bg-card border border-border">
          <p className="text-muted-foreground">
            Cost-benefit analysis tool, debate simulation, and ethical scenario builder coming soon.
          </p>
        </div>
      </section>

      <VideoEmbed videos={unitVideos.unit8} />
      <WebQuest content={unitWebQuests.unit8} />
      <FunFacts facts={unitFunFacts.unit8} />
      <CareerExploration careers={unitCareers.unit8} />
      <STEMConnectionsSection />
      <SelfCheckingQuiz quiz={unitQuizzes.unit8} unitId="unit8" />
    </UnitLayout>
  );
}
